...
export const ColumnsIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 4.5v15m6-15v15m-10.5-15h15a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25v-10.5A2.25 2.25 0 013.75 4.5z" />
  </svg>
);
...
export const StarIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M10.868 2.884c.321-.662 1.215-.662 1.536 0l1.681 3.462a1 1 0 00.951.692h3.632c.712 0 1.002.916.484 1.345l-2.938 2.14a1 1 0 00-.364 1.118l1.104 3.794c.259.89-1.002 1.623-1.688 1.135l-3.134-2.274a1 1 0 00-1.175 0l-3.134 2.274c-.686.488-1.947-.245-1.688-1.135l1.104-3.794a1 1 0 00-.364-1.118L2.27 8.384c-.518-.43-.228-1.345.484-1.345h3.632a1 1 0 00.951-.692l1.681-3.462z" clipRule="evenodd" />
  </svg>
);

export const WrenchIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.471-2.471a2.652 2.652 0 00-3.75-3.75L7.845 11.42M11.42 15.17L5.877 21m6.46-4.828l.007.007m-.007-.007l-.007.007m.007-.007l-.007.007M12 21v-3.375A4.125 4.125 0 007.875 12H4.5" />
  </svg>
);
...
export const ArrowTopRightOnSquareIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6L21 12.75" />
    </svg>
);
